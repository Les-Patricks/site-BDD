...
/**
 * Preuve statique que les onglets branchent notify sur succes / echec (ajout, renommage, suppression).
 * Le comportement metier addWord/addFamily/addLanguage est deja couvert par `state.test.js`.
 */
describe("Onglets + notify (contrat source)", () => {
	...
	it("succes suppression / renommage / traduction : durationMs 2500", async () => {
