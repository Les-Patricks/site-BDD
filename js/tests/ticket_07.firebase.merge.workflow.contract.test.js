...
/** Contrat CI Ticket 07 : merge -> Hosting live (main) + canal dev (branche dev) */
describe("Ticket 07 - Firebase Hosting merge workflow contract", () => {
	let yml;
	...
	it("T-07-1: push declenche sur main et dev", () => {
	...
	it("T-07-2: job live sur main avec channelId live, job dev sur dev avec channelId dev", () => {
	...
	it("T-07-3: config Supabase et action-hosting-deploy repetes par job", () => {
