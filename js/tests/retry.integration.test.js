...
describe("retry UI after failures", () => {
	it("save echec restaure le bouton Save pour retry", async () => {
	...
	it("publish echec doit restaurer le bouton Publish pour retry", async () => {
		const saveBtn = mkBtn("Save");
		const publishBtn = mkBtn("Publish");
	...
	it("publish succes conserve le masquage du bouton Publish", async () => {
		const saveBtn = mkBtn("Save");
		const publishBtn = mkBtn("Publish");
		const confirmPublishBtn = mkBtn("Publish");
		const cancelPublishBtn = mkBtn("Cancel");
