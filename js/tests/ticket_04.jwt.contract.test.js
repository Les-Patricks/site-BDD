...
describe("Ticket 04 - JWT verification (deploy + contract)", () => {
	it("CA-04-1: aucun script deploy:* ne desactive verify-jwt", async () => {
	...
	it("CA-04-2: le front appelle les fonctions via functions.invoke (JWT session implicite)", async () => {
...
describeJwtRemote("Ticket 04 - Optional remote JWT gate (RUN_JWT_GATE_TEST=1)", () => {
