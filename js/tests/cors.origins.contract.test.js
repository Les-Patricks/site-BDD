...
describe("CORS origins contract", () => {
	let adminBootstrap;
	let adminSave;
	...
	it("shared list keeps production and dev hosting origins", () => {
	...
	it("admin-bootstrap and admin-save import shared CORS helpers", () => {
		expect(adminBootstrap).toContain("../_shared/corsOrigins.ts");
		expect(adminSave).toContain("../_shared/corsOrigins.ts");
	});

	it("publish-to-firebase import shared CORS helpers", () => {
